...
@Component({
    ...
    template: `
		<ng-container>
            <div *ngIf="root && item.visible !== false" class="layout-menuitem-root-text"><i class="{{item.icon}}" (click)="iconRootClick(item)"  style="cursor:pointer"></i> {{item.label}}</div>
			...
			<ul *ngIf="item.items && item.visible !== false" [@children]="submenuAnimation">
				<ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
					<li app-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass" *ngIf="!item.hideSubItem"></li>
				</ng-template>
			</ul>
		</ng-container>
    `,
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    iconRootClick(item: any) {
        item.hideSubItem = !item.hideSubItem;
    }
